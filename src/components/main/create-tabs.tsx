...
const CreateTabs = (props: Props) => {
  ...
  return (
    <div className="flex gap-3 md:flex-row flex-col">
      <div className="w-full md:w-1/3 border h-fit rounded-lg p-2 md:space-y-2 space-y-0 overflow-auto flex gap-2 md:gap-0 md:flex-col flex-row darkbg-[#27272A] bg-[#FAFBFC] dark:bg-[#27272A]">
          {/* Website */}
          <div onClick={() => setTab("website")} className={cn(
            `p-2 rounded-lg  dark:hover:bg-[#3F3F45] hover:bg-gray-200 transition-all border border[#443F3C] flex-1`,
            ...
            <p className="mt-1 font-satoshi hidden md:flex text-sm">Add a website URL</p>
          </div>
          {/* Notes */}
          <div onClick={() => setTab("notes")} className={cn(
            `p-2 rounded-lg dark:hover:bg-[#3F3F45] hover:bg-gray-200 transition-all border flex-1`,
            ...
            <p className="mt-1 font-satoshi text-sm hidden md:flex">Add a note</p>
          </div>
          {/* Tweet */}
          <div onClick={() => setTab("tweet")} className={cn(
            ...
            <p className="mt-1 font-satoshi text-sm hidden md:flex">Add a tweet URL</p>
          </div>
          {/* Video */}
          <div onClick={() => setTab("video")} className={cn(
            ...
            <p className="mt-1 font-satoshi text-sm hidden md:flex">Add a youtube video URL</p>
          </div>
          {/* Folder */}
          <div onClick={() => setTab("folder")} className={cn(
            ...
            <p className="mt-1 font-satoshi text-sm hidden md:flex">
